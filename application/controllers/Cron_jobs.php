...
//echo date("Y-m-d",strtotime("+1 day"));
            ...
            $data = $this->subscription_model->view(["from_date >=" => date("Y-m-d"), "to_date <=" => date("Y-m-d")]);
            print_r($data);
            foreach ($data as $d) {
                    ...
                    if (is_null($d->last_order_date) || strtotime($d->last_order_date) < strtotime(date("Y-m-d", strtotime("+7 day")))) {
                        if (is_null($d->next_order_date) || strtotime($d->next_order_date) == strtotime(date("Y-m-d"))) {
                            ...
                            if ($chargeJson['amount_refunded'] == 0 && empty($chargeJson['failure_code']) && $chargeJson['paid'] == 1 && $chargeJson['captured'] == 1) {
                                ...
                                $data = $this->subscription_model->edit(["last_order_date" => date("Y-m-d", strtotime("+1 day")), "next_order_date" => date("Y-m-d", strtotime("+7 day"))], $d->id);
                            } else {
