...
$fromComment = [
    ...
    "data-validation-error-msg" => $this->lang->line("people_input_com_emsg"),
    'id' => "comment",
    "placeholder" => $this->lang->line("people_input_com_plac"),
        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= base_url("admin/setting/people/") ?>" class="btn btn-info btn-sm"><?= $this->lang->line("btn_list") ?></a>
                </div>
            </div>
            <!-- /.card-header -->
            <?= form_open_multipart(); ?>
            <div class="card-body">
                <div class="form-group">
                    <label><?= $this->lang->line("people_name") ?></label>
                    <?= form_input($fromName); ?>
                </div>  
                <div class="form-group">
                    <label><?= $this->lang->line("people_com") ?></label>
                    <?= form_textarea($fromComment); ?>
                </div>  
                <div class="form-group">
                    <label><?= $this->lang->line("people_img") ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <?= isset($img) ? '<img src="' . base_url("assert/people/" . $img) . '" class="img-thumbnail img-responsive" style="width:100px">' : ""; ?>
                        <div class="d-none">
...
<script>
    ...
    var Demo = (function() {
        function demoUpload() {
            ...
            <?= isset($img) ? "\$uploadCrop.croppie('bind', '" . base_url("assert/people/" . $img) . "');" : "\$uploadCrop.croppie('bind', '" . base_url("assert/people/user_demo.png") . "');"; ?>
