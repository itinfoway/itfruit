...
$fromName = [
    ...
    "data-validation-error-msg" => $this->lang->line("Slider_input_name_emsg"),
    'id' => "name",
    "placeholder" => $this->lang->line("Slider_input_name_plac"),
...
$fromLink = [
    ...
    'id' => "link",
    "placeholder" => $this->lang->line("Slider_input_link_plac"),
    ...
    <div class="col-md-12">
        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <h3 class="card-title"><?= $this->lang->line("Slider_head") ?></h3>
                <div class="card-tools">
                    <a href="<?= base_url("admin/setting/slider/index") ?>" class="btn btn-info btn-sm"><?= $this->lang->line("btn_list") ?></a>
                </div>
            </div>
            <!-- /.card-header -->
            <?= form_open_multipart(); ?>
            <div class="card-body">
                <div class="form-group">
                    <label><?= $this->lang->line("Slider_name") ?></label>
                    <?= form_input($fromName); ?>
                </div>      
                
                <div class="form-group">
                    <label><?= $this->lang->line("Slider_img") ?></label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <?= isset($img) ? '<img src="' . base_url("assert/slider/" . $img) . '" class="img-thumbnail img-responsive" style="width:100px">' : ""; ?>
                        <div class="d-none">
               ...
               <div class="form-group">
                    <label><?= $this->lang->line("Slider_link") ?></label>
                    <?= form_input($fromLink); ?>
                </div> 
...
<script>
    ...
    var Demo = (function() {
        function demoUpload() {
            ...
            <?= isset($img) ? "\$uploadCrop.croppie('bind', '" . base_url("assert/slider/" . $img) . "');" : "\$uploadCrop.croppie('bind', '" . base_url("assert/slider/user_demo.png") . "');"; ?>
