...
$fromPass = [
    ...
    // "data-validation-error-msg"=>$this->lang->line("alacarte_input_pass_emsg"),
    'id' => "pass",
    'readonly'=>'true',
...
$fromCredit = [
    ...
    // "data-validation-length"=>"1-5",
    // "data-validation-allowing"=>"float",
    // "data-validation-error-msg"=>$this->lang->line("alacarte_input_credit_emsg"),
    'readonly'=>'true',
    'id' => "credit",
...
$fromYoupay = [
    ...
    //  "data-validation-error-msg"=>$this->lang->line("alacarte_input_youpay_emsg"),
   'readonly'=>'true',
    'class' => 'form-control',
    'id' => "youpay",
...
$fromValidity = [
    ...
    // "data-validation-length"=>"min2",
    // "data-validation-allowing"=>"float",
     // "data-validation-error-msg"=>$this->lang->line("alacarte_input_val_emsg"),
    'readonly'=>'true',
    'class' => 'form-control',
    'id' => "validity",
...
$fromSavings = [
    ...
    // "data-validation-allowing"=>"float",
    //  "data-validation-error-msg"=>$this->lang->line("alacarte_input_saveing_emsg"),
    'readonly'=>'true',
    'class' => 'form-control',
    'id' => "savings",
