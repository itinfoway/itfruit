...
$fromLatitude = [
    ...
    "data-validation-error-msg"=>$this->lang->line("address_input_latitude_emsg"),
    'id' => "latitude",
...
$fromLongitude = [
    ...
    "data-validation"=>"length",
    "data-validation-length"=>"5-10",
    "data-validation-error-msg"=>$this->lang->line("address_input_longitude_emsg"),
    'id' => "longitude",
...
$fromAddress1 = [
    ...
    "data-validation-error-msg"=>$this->lang->line("address_input_add1_emsg"),
    'id' => "address1",
...
$fromAddress2 = [
    ...
    "data-validation-length"=>"6-50",
    "data-validation-error-msg"=>$this->lang->line("address_add2_input_emsg"),
    'id' => "address2",
...
$fromCity = [
    ...
    "data-validation-error-msg"=>$this->lang->line("address_input_no_emsg"),
    'id' => "city",
...
$fromCode = [
    ...
    "data-validation"=>"length",
    "data-validation-length"=>"5-10",
    "data-validation-error-msg-length"=>$this->lang->line("address_input_code_emsg"),
    'id' => "postalcode",
...
$fromState = [
  ...
  "data-validation-error-msg"=>$this->lang->line("address_input_state_emsg"),
    'id' => "state",
...
$fromCountry = [
    ...
    "data-validation"=>"length",
    "data-validation-length"=>"5-15",
  "data-validation-error-msg"=>$this->lang->line("address_input_con_emsg"),
    'id' => "country",
