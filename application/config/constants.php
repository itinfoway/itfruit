...
defined('VITAMIN_NAME')      or define('VITAMIN_NAME', "vitamin"); // highest automatically-assigned error code
defined('CONTACT')      or define('CONTACT', "contactus"); // highest automatically-assigned error code
defined('USERS')      or define('USERS', "users"); // highest automatically-assigned error code
defined('FRUIT_NAME')      or define('FRUIT_NAME', "fruit"); // highest automatically-assigned error code
...
defined('ORDER_LOADING')      or define('ORDER_LOADING', "order_loadings"); // highest automatically-assigned error
